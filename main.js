...
var concertData = document.querySelectorAll("#content p");
...
var concertNode = document.getElementById("concerts");

for (var i = 0; i < concerts.length; i++) {
    var e = document.createElement("p")
    e.innerHTML = concerts[i].date + ": " + concerts[i].artist + ", " + concerts[i].venue;
    concertNode.appendChild(e);
};
